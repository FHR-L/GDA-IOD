...
log_level = 'INFO'
load_from = '/home/Newdisk/luowenlong/Projects/ERD/work_dirs/faster-rcnn_r50_fpn/coco66-2/epoch_6.pth'
resume = False
...
optim_wrapper = dict(
    type='AmpOptimWrapper',
    optimizer=dict(type='AdamW', lr=0.00005, weight_decay=0.1),
